...
- **Payment Gateways** - There are lots of payment gateway options available, including our existing payment providers (Adyen and Paypal). We also have the option of using [Shopify Payments](https://help.shopify.com/en/manual/payments/shopify-payments), which makes other payment method integrations (e.g. Amazon Pay, Apple Pay, Google Pay) available without any development work.
